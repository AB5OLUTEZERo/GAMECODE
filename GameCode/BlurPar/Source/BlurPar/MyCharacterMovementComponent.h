 ...
 */
UCLASS()
class BLURPAR_API UMyCharacterMovementComponent : public UCharacterMovementComponent
{
	GENERATED_BODY()
...
#pragma endregion
#pragma region DoubleJump Functions
	UPROPERTY(EditAnywhere, Category = "DoubleJump")
		float JumpStrength;
	UPROPERTY(EditAnywhere, Category = "DoubleJump")
		float WallJumpStrengthMultiplier;
	...
	UFUNCTION(Server, Reliable, WithValidation)
		void ServerSetJumpDirection(const FVector& JumpDir);
