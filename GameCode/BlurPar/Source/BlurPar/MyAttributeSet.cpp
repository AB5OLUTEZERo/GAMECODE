...
void UMyAttributeSet::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
	...
	DOREPLIFETIME_CONDITION_NOTIFY(UMyAttributeSet, MaximumHealth, COND_None, REPNOTIFY_Always);
...
void UMyAttributeSet::OnRep_MaximumHealth(const FGameplayAttributeData & OldValue)
{

	GAMEPLAYATTRIBUTE_REPNOTIFY(UMyAttributeSet, MaximumHealth, OldValue);
}

void UMyAttributeSet::OnRep_HealthRegeneration(const FGameplayAttributeData & OldValue)
{
