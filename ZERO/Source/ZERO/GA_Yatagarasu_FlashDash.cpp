...
#include "GA_Yatagarasu_FlashDash.h"
...
UGA_Yatagarasu_FlashDash::UGA_Yatagarasu_FlashDash()
{
...
void UGA_Yatagarasu_FlashDash::ActivateAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo * ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo, const FGameplayEventData * TriggerEventData)
{
...
//Spawning a Teleporter effect in the players location
	...
	TaskM->OnTargetLocationReached.AddDynamic(this, &UGA_Yatagarasu_FlashDash::LocationReached);
	TaskM->ReadyForActivation();
}

void UGA_Yatagarasu_FlashDash::LocationReached()
{
